...
4. **LLM Command Processing**: Transforms raw recognized speech into structured actions or corrected commands using **Liquid AI LFM 2.5 (2.6B GGUF)** via `llama-server`.
...
sequenceDiagram
    ...
    participant LLM as llama-server LFM 2.5 (:8084)
...
* **Liquid AI LFM 2.5 (2.6B GGUF)**: [LFM2.5-2.6B-Q4_0.gguf](https://huggingface.co/LiquidAI/LFM2.5-2.6B-GGUF/blob/main/LFM2.5-2.6B-Q4_0.gguf)
...
### Step 3: Start LFM 2.5 LLM Server (Port 8084)
```cmd
...
| **LFM 2.5 LLM** | HTTP | `127.0.0.1:8084` | `/v1/chat/completions` | Command transformation & correction |
